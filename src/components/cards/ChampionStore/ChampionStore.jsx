...
const PokeCard = ({ id, item : data })=>{
    ...
    return <article id={id} className="pokemon-card" onClick={()=>{ handleClick() }} > {/* Unique key and card class */}
        <img
            className="pokemon"
        ...
        />    
            ...
            <div className="price">
                <div className="rp-price"><img className="rp-icon-card" src="/general/RP_icon.png"></img><span className="price-number">{data.price.rp}</span></div>
                <div className="essences-price"><img className="be-icon-card" src="/general/BE_icon.png"></img><span className="price-number">{data.price.be}</span></div>         
            </div>
            </div>
