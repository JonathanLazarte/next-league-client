...
import { setFriendsOnline, setPartyMembers, type FriendFolders } from "@/redux/slices/connectedUsersSlice";
...
export function useConnectedUsers() {
  ...
  const updateFriendsOnline = useCallback((payload: FriendFolders ) => dispatch(setFriendsOnline(payload)), [dispatch]);
